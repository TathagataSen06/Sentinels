...
from sentinels.modules.http import (
    BasicLogin,
    CanaryHTTP,
...
class CanaryHTTPS(CanaryService):
    ...
    def __init__(self, config=None, logger=None):
        ...
        self.certificate_path = Path(
            config.getVal(
                "https.certificate", default="/etc/ssl/sentinels/sentinels.pem"
            )
        )
        self.key_path = Path(
            config.getVal("https.key", default="/etc/ssl/sentinels/sentinels.key")
        )
