...
class SmbPlugin(SentinelsPlugin):
    """
    Auto-generated Sentinels Plugin for smb
    """
    ...
    def init(self, config: Dict[str, Any]) -> None:
        ...
        logger.info(f"Initialized SmbPlugin on port {self.port}")

    def start(self) -> None:
        self.is_running = True
        logger.info(f"Starting SmbPlugin...")
    ...
    def stop(self) -> None:
        self.is_running = False
        logger.info(f"Stopping SmbPlugin...")
